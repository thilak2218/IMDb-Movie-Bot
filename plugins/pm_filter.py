...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+G4xvb46moU81ZTU1"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/moviehubofficial18'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/+Mv3AtoOsJZs2OWU1')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/moviereqgroup_movieshub')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/moviehubofficial18'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/+Mv3AtoOsJZs2OWU1')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('netflix channel', url='https://t.me/+a3sBL2BzimM0Mzdl')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/moviehubofficial18'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ English Movie", url="https://t.me/+XRVefdR7Yq8yMmY1"),
        InlineKeyboardButton("Netflix series ⭕️", url="https://t.me/+a3sBL2BzimM0Mzdl")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/+Mv3AtoOsJZs2OWU1")
    ])
